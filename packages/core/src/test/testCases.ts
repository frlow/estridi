...
export const standardTestCase: Scraped = [
  ...
  },
  {
    ...
    type: 'gateway',
    variant: 'gateway',
    ...autoText('Any errors from api call?'),
    options: {
      ShowErrorId: 'yes',
      ScriptId: 'no',
    },
  ...
  },
  {
    ...
    type: 'script',
    variant: 'message',
    ...autoText('Show an error message'),
  ...
  },
  {
    ...
    type: 'end',
    ...autoText('end'),
    extra: { x: 2050, y: 0, width: 80, height: 80 },
  },
  {
    id: 'SubprocessId',
    ...autoText('Next page'),
  ...
  },
  {
    ...
    type: 'script',
    variant: 'signalSend',
    ...autoText('Go to some page'),
    extra: { x: 350, y: 500, width: 80, height: 80 },
  },
]

export const getFigmaTestData = () =>
  JSON.parse(fs.readFileSync('./src/sources/figma.json', 'utf8'))
