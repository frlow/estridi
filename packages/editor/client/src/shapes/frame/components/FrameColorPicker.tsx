...
import { FRAME_COLORS } from "../../util/constants";
import { Editor, TLFrameShape, } from '@tldraw/editor';

export const FrameColorPicker = ({ shape, editor, isSelected }: {
    ...
    return <div
        ...
        <div style={{
            ...
            {(Object.keys(FRAME_COLORS) as Array<keyof typeof FRAME_COLORS>).map((colorKey) => (
                <button
                    key={colorKey}
                    onClick={() => {
                        editor.updateShape({
