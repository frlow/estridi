import { Steps } from './some_feature.spec'
export const steps: Steps = {
  ...
  "Validate Gatuadress: Input field, RequiredString Format 135 characters, ": async state => {debugger ;throw "Not implemented"},
  "Validate Land: DropdownInputSelectDesktop, RequiredString Format 12 characters, Default value Sverige": async state => {debugger ;throw "Not implemented"},
  "Validate Mottagarens namn: Input field, RequiredString Format 135 characters, ": async state => {debugger ;throw "Not implemented"},
  "Validate Postnummer: Input field, Required String Format 135 characters, ": async state => {debugger ;throw "Not implemented"},
}