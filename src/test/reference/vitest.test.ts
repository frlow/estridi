...
describe('vitest', () => {
  describe('message: Could not load page, 3085:4054', t('3085:4054'))
  describe('message: Could not load page, 3085:4090', t('3085:4090'))
  describe('message: Show Sections Från Till Betalning Granska Godkänn, 3229:5359', t('3229:5359'))
  describe('message: Could not load page, 3085:4080', t('3085:4080'))
  describe('script: Open section Från, 3229:5382', t('3229:5382'))
  describe('subprocess: Display fields Payer data, 3229:5394', t('3229:5394'))
  describe('subprocess: Validate fields Payer data, 3229:5526', t('3229:5526'))
  describe('script: Hide button Fortsätt, 3501:5498', t('3501:5498'))
  describe('message: Show Payer data validation errors, 3088:5070', t('3088:5070'))
  describe('script: Open section Till, 3229:5589', t('3229:5589'))
  describe('subprocess: Display fields New recipient data, 3088:5337', t('3088:5337'))
  describe('script: Set IBAN BBAN label to IBAN, 3088:5551', t('3088:5551'))
  describe('script: Hide BIC SWIFT field, 3088:5558', t('3088:5558'))
  describe('signalSend: https www lansforsakringar se 49bd3e globalassets aa global dokument information landinformation pdf, 3088:5333', t('3088:5333'))
  describe('script: Show BIC SWIFT or National ID AND Show BBAN, 3088:5346', t('3088:5346'))
  describe('subprocess: Validate fields recipient data, 3088:5196', t('3088:5196'))
  describe('script: IBAN length is applied to field and infotext is updated, 4893:6573', t('4893:6573'))
  describe('script: Show BIC SWIFT field required AND Show BBAN, 3088:5348', t('3088:5348'))
  describe('message: Show errors, 3088:5216', t('3088:5216'))
  describe('script: Show BIC SWIFT field optional AND Show IBAN, 3088:5347', t('3088:5347'))
  describe('script: Hide BIC SWIFT field AND Show IBAN, 3088:5345', t('3088:5345'))
  describe('script: Open section Betalning, 3229:5682', t('3229:5682'))
  describe('subprocess: Display fields Payment data, 3088:5982', t('3088:5982'))
  describe('script: Show avgift section, 3885:5933', t('3885:5933'))
  describe('script: Hide avgift section, 3885:5932', t('3885:5932'))
  describe('script: Open info about avgift, 3781:5751', t('3781:5751'))
  describe('subprocess: Validate fields Payment data, 3229:5714', t('3229:5714'))
  describe('script: Open info about currency, 3781:5673', t('3781:5673'))
  describe('script: Set currencyCode to SEK, 3781:5651', t('3781:5651'))
  describe('message: Show ISO Curency Code in Amount field, 3088:6182', t('3088:6182'))
  describe('message: Show errors, 3229:5733', t('3229:5733'))
  describe('script: Show betalningsreferens, 3088:6009', t('3088:6009'))
  describe('script: Hide betalningsreferens, 3088:6006', t('3088:6006'))
  describe('signalSend: https www lansforsakringar se 49334d globalassets aa global dokument prislistor 08198 prislista privat pdf, 3781:5750', t('3781:5750'))
  describe('signalSend: https www lansforsakringar se 48efa3 globalassets aa global dokument information landinformation pdf, 4238:4585', t('4238:4585'))
  describe('signalSend: https www dnb se se sv markets valuta rentor kurslista overforing daglig, 3088:6241', t('3088:6241'))
  describe('message: Display correct errors for incorrect fields, 3895:5990', t('3895:5990'))
  describe('message: Show Modal Validated recipient fields, 3895:6006', t('3895:6006'))
  describe('message: Show Last 3 Alert Messages, 4893:6322', t('4893:6322'))
  describe('message: Show All Alert Messages, 4893:6282', t('4893:6282'))
  describe('script: Close recipient summary modal, 3973:6779', t('3973:6779'))
  describe('subprocess: view security authentication id2, 3895:6017', t('3895:6017'))
  describe('message: Show error, 3895:6015', t('3895:6015'))
  describe('script: Close recipient signing modal, 3895:6032', t('3895:6032'))
  describe('message: Display some error, 3904:6623', t('3904:6623'))
  describe('subprocess: Payment summary page, 3895:6028', t('3895:6028'))
})
