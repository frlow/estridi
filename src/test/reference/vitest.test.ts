...
describe('vitest', () => {
  ...
  test('signalSend: https www lansforsakringar se 49bd3e globalassets aa global dokument information landinformation pdf, 3088:5333', t('3088:5333'))
  ...
  test('script: Show avgift section, 3885:5933', t('3885:5933'))
  test('script: Hide avgift section, 3885:5932', t('3885:5932'))
  test('script: Open info about avgift, 3781:5751', t('3781:5751'))
  test('subprocess: Validate fields Payment data, 3229:5714', t('3229:5714'))
  test('script: Open info about currency, 3781:5673', t('3781:5673'))
  test('script: Set currencyCode to SEK, 3781:5651', t('3781:5651'))
  ...
  test('signalSend: https www lansforsakringar se 49334d globalassets aa global dokument prislistor 08198 prislista privat pdf, 3781:5750', t('3781:5750'))
  test('signalSend: https www lansforsakringar se 48efa3 globalassets aa global dokument information landinformation pdf, 4238:4585', t('4238:4585'))
  test('signalSend: https www dnb se se sv markets valuta rentor kurslista overforing daglig, 3088:6241', t('3088:6241'))
  test('message: Display correct errors for incorrect fields, 3895:5990', t('3895:5990'))
  test('message: Show Modal Validated recipient fields, 3895:6006', t('3895:6006'))
  test('script: Close recipient summary modal, 3973:6779', t('3973:6779'))
  test('subprocess: view security authentication id2, 3895:6017', t('3895:6017'))
  test('message: Show error, 3895:6015', t('3895:6015'))
